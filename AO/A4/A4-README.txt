ZHAO-II : Ziggy's (new) HUD Animation Overrider

ZHAO-II by Ziggy Puff, mod by Marcus Gray, Johann Ehrler & Moeka Kohime

==============================
IMPORTANT information for ANIMATION CREATORS
==============================

I (Marcus Gray) offer the possibility to get a branded ZHAO-II MB2 with your logo and your name as creator ***FOR FREE*** (tips appreciated tho ;-] ):
Just send me (Marcus Gray) any full perm prim YOU created which i then will use as new root prim for the ZHAO-II MB2.
If  necessary i also offer modifying your logo to fit the other buttons.
The prim with the logo contains a script that gives any inventory (notecards, Landmarks, etc.) of THAT PRIM to the user.

PLAESE USE THIS OFFER SO PEOPLE CAN CONTACT **YOU** WHEN HAVING PROBLEMS, NOT ME  :-P


=============
NEW in ZHAO-II MB2.x
=============
...
If you bought this Animation Overrider (AO) pre-loaded with animations, and you need help with the animations, please do not IM Ziggy Puff with questions. I (Ziggy) only make the AO (which is a free product), I do not make or sell any animations. The AO is a separate product from the animations that are contained within it. Some animation creators use my AO to package and sell their animations. That's why it shows me as the creator of the AO.
